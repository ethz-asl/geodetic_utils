...
if __name__ == "__main__":
    # RTK:
    #a = GpsNoiser(white=np.array([0.001, 0.001, 0.002]),
    #              pink=np.array([0.0035, 0.0035, 0.007]),
    #              brown=np.array([0.0000, 0.0000, 0.000]),
    #              epsilons=np.array([0, 1, 2]))

    # SPP:
    a = GpsNoiser(white=np.array([0.001, 0.001, 0.0020]),
                  pink=np.array([0.0, 0.0, 1.6]),
                  brown=np.array([0.50, 0.5, 6]),
    ...
    plt.figure(figsize=[6,6])
    plt.scatter(rtk_data[:,0], rtk_data[:,1], c=np.arange(len(rtk_data)), marker="x")
    ...
    plt.figure(figsize=[6,6])
    plt.scatter(sim_data[:, 0], sim_data[:, 1], c=np.arange(len(sim_data)), marker="x")
